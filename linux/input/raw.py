...
# This file has been generated by linux.input
# Date: 2023-09-22 07:32:34.491278
# System: Linux
...
class input_absinfo(Struct):
    pass
input_absinfo._fields_ = [("value", cint), ("minimum", cint), ("maximum", cint), ("fuzz", cint), ("flat", cint), ("resolution", cint)]
...
class ff_condition_effect(Struct):
    pass
ff_condition_effect._fields_ = [("right_saturation", u16), ("left_saturation", u16), ("right_coeff", i16), ("left_coeff", i16), ("deadband", u16), ("center", i16)]


class ff_periodic_effect(Struct):
    pass
ff_periodic_effect._fields_ = [("waveform", u16), ("period", u16), ("magnitude", i16), ("offset", i16), ("phase", u16), ("envelope", ff_envelope), ("custom_len", cuint), ("custom_data", POINTER(i16))]
...
class ff_effect(Struct):
    class M1(Union):
        pass
    M1._fields_ = [("constant", ff_constant_effect), ("ramp", ff_ramp_effect), ("periodic", ff_periodic_effect), ("condition", ff_condition_effect * 2), ("rumble", ff_rumble_effect)]


ff_effect._fields_ = [("type", u16), ("id", i16), ("direction", u16), ("trigger", ff_trigger), ("replay", ff_replay), ("u", ff_effect.M1)]



class IOC(enum.IntEnum):
    GVERSION = _IOR('E', 0x01, int)			# get driver version
    GID = _IOR('E', 0x02, input_id)	# get device ID
    GREP = _IOR('E', 0x03, unsigned int[2])	# get repeat settings
    SREP = _IOW('E', 0x03, unsigned int[2])	# set repeat settings
    GKEYCODE = _IOR('E', 0x04, unsigned int[2])        # get keycode
    GKEYCODE_V2 = _IOR('E', 0x04, input_keymap_entry)
    SKEYCODE = _IOW('E', 0x04, unsigned int[2])        # set keycode
    SKEYCODE_V2 = _IOW('E', 0x04, input_keymap_entry)
    SFF = _IOW('E', 0x80, ff_effect)	# send a force effect to a force feedback device
    RMFF = _IOW('E', 0x81, int)			# Erase a force effect
    GEFFECTS = _IOR('E', 0x84, int)			# Report number of effects playable at the same time
    GRAB = _IOW('E', 0x90, int)			# Grab/Release device
    REVOKE = _IOW('E', 0x91, int)			# Revoke device access
    GMASK = _IOR('E', 0x92, input_mask)	# Get event-masks
    SMASK = _IOW('E', 0x93, input_mask)	# Set event-masks
    SCLOCKID = _IOW('E', 0xa0, int)			# Set clockid to be used for timestamps
