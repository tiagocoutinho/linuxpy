...
IO = functools.partial(ioctl.IO, MAGIC)
IOR = functools.partial(ioctl.IOR, MAGIC)
IOW = functools.partial(ioctl.IOW, MAGIC)
IOWR = functools.partial(ioctl.IOWR, MAGIC)
...
VIDIOC_REQBUFS = IOWR(8, v4l2_requestbuffers)
VIDIOC_QUERYBUF = IOWR(9, v4l2_buffer)
VIDIOC_G_FBUF = IOR(10, v4l2_framebuffer)
VIDIOC_S_FBUF = IOW(11, v4l2_framebuffer)
VIDIOC_OVERLAY = IOW(14, ctypes.c_int)
VIDIOC_QBUF = IOWR(15, v4l2_buffer)
VIDIOC_DQBUF = IOWR(17, v4l2_buffer)
VIDIOC_STREAMON = IOW(18, ctypes.c_int)
VIDIOC_STREAMOFF = IOW(19, ctypes.c_int)
VIDIOC_G_PARM = IOWR(21, v4l2_streamparm)
VIDIOC_S_PARM = IOWR(22, v4l2_streamparm)
VIDIOC_G_STD = IOR(23, v4l2_std_id)
VIDIOC_S_STD = IOW(24, v4l2_std_id)
VIDIOC_ENUMSTD = IOWR(25, v4l2_standard)
VIDIOC_ENUMINPUT = IOWR(26, v4l2_input)
VIDIOC_G_CTRL = IOWR(27, v4l2_control)
VIDIOC_S_CTRL = IOWR(28, v4l2_control)
VIDIOC_G_TUNER = IOWR(29, v4l2_tuner)
VIDIOC_S_TUNER = IOW(30, v4l2_tuner)
VIDIOC_G_AUDIO = IOR(33, v4l2_audio)
VIDIOC_S_AUDIO = IOW(34, v4l2_audio)
VIDIOC_QUERYCTRL = IOWR(36, v4l2_queryctrl)
VIDIOC_QUERYMENU = IOWR(37, v4l2_querymenu)
VIDIOC_G_INPUT = IOR(38, ctypes.c_int)
VIDIOC_S_INPUT = IOWR(39, ctypes.c_int)
VIDIOC_G_OUTPUT = IOR(46, ctypes.c_int)
VIDIOC_S_OUTPUT = IOWR(47, ctypes.c_int)
VIDIOC_ENUMOUTPUT = IOWR(48, v4l2_output)
VIDIOC_G_AUDOUT = IOR(49, v4l2_audioout)
VIDIOC_S_AUDOUT = IOW(50, v4l2_audioout)
VIDIOC_G_MODULATOR = IOWR(54, v4l2_modulator)
VIDIOC_S_MODULATOR = IOW(55, v4l2_modulator)
VIDIOC_G_FREQUENCY = IOWR(56, v4l2_frequency)
VIDIOC_S_FREQUENCY = IOW(57, v4l2_frequency)
VIDIOC_CROPCAP = IOWR(58, v4l2_cropcap)
VIDIOC_G_CROP = IOWR(59, v4l2_crop)
VIDIOC_S_CROP = IOW(60, v4l2_crop)
VIDIOC_G_JPEGCOMP = IOR(61, v4l2_jpegcompression)
VIDIOC_S_JPEGCOMP = IOW(62, v4l2_jpegcompression)
VIDIOC_QUERYSTD = IOR(63, v4l2_std_id)
VIDIOC_TRY_FMT = IOWR(64, v4l2_format)
VIDIOC_ENUMAUDIO = IOWR(65, v4l2_audio)
VIDIOC_ENUMAUDOUT = IOWR(66, v4l2_audioout)
VIDIOC_G_PRIORITY = IOR(67, v4l2_priority)
VIDIOC_S_PRIORITY = IOW(68, v4l2_priority)
VIDIOC_G_SLICED_VBI_CAP = IOWR(69, v4l2_sliced_vbi_cap)
VIDIOC_LOG_STATUS = IO(70)
VIDIOC_G_EXT_CTRLS = IOWR(71, v4l2_ext_controls)
VIDIOC_S_EXT_CTRLS = IOWR(72, v4l2_ext_controls)
VIDIOC_TRY_EXT_CTRLS = IOWR(73, v4l2_ext_controls)

VIDIOC_ENUM_FRAMESIZES = IOWR(74, v4l2_frmsizeenum)
VIDIOC_ENUM_FRAMEINTERVALS = IOWR(75, v4l2_frmivalenum)
VIDIOC_G_ENC_INDEX = IOR(76, v4l2_enc_idx)
VIDIOC_ENCODER_CMD = IOWR(77, v4l2_encoder_cmd)
VIDIOC_TRY_ENCODER_CMD = IOWR(78, v4l2_encoder_cmd)

VIDIOC_DBG_S_REGISTER = IOW(79, v4l2_dbg_register)
VIDIOC_DBG_G_REGISTER = IOWR(80, v4l2_dbg_register)

VIDIOC_DBG_G_CHIP_IDENT = IOWR(81, v4l2_dbg_chip_ident)

VIDIOC_S_HW_FREQ_SEEK = IOW(82, v4l2_hw_freq_seek)
VIDIOC_ENUM_DV_PRESETS = IOWR(83, v4l2_dv_enum_preset)
VIDIOC_S_DV_PRESET = IOWR(84, v4l2_dv_preset)
VIDIOC_G_DV_PRESET = IOWR(85, v4l2_dv_preset)
VIDIOC_QUERY_DV_PRESET = IOR(86, v4l2_dv_preset)
VIDIOC_S_DV_TIMINGS = IOWR(87, v4l2_dv_timings)
VIDIOC_G_DV_TIMINGS = IOWR(88, v4l2_dv_timings)
VIDIOC_DQEVENT = IOR(89, v4l2_event)
VIDIOC_SUBSCRIBE_EVENT = IOW(90, v4l2_event_subscription)
VIDIOC_UNSUBSCRIBE_EVENT = IOW(91, v4l2_event_subscription)

VIDIOC_G_SELECTION = IOWR(94, v4l2_selection)
VIDIOC_S_SELECTION = IOWR(95, v4l2_selection)

VIDIOC_OVERLAY_OLD = IOWR(14, ctypes.c_int)
VIDIOC_S_PARM_OLD = IOW(22, v4l2_streamparm)
VIDIOC_S_CTRL_OLD = IOW(28, v4l2_control)
VIDIOC_G_AUDIO_OLD = IOWR(33, v4l2_audio)
VIDIOC_G_AUDOUT_OLD = IOWR(49, v4l2_audioout)
VIDIOC_CROPCAP_OLD = IOR(58, v4l2_cropcap)

VIDIOC_QUERY_EXT_CTRL = IOWR(103, v4l2_query_ext_ctrl)
