...
MACRO_ENUMS = [
    CEnum("SelectionFlag", "V4L2_SEL_FLAG_"),
    CEnum("SelectionTarget", "V4L2_SEL_TGT_"),
    #CEnum("SelectionTarget", "V4L2_SUBDEV_SEL_TGT_"),
    CEnum("Capability", "V4L2_CAP_", "IntFlag"),
    CEnum("PixelFormat", "V4L2_PIX_FMT_"),
    #CEnum("BufferType", "V4L2_BUF_TYPE_"),
    CEnum("BufferFlag", "V4L2_BUF_FLAG_"),
    CEnum("Memory", "V4L2_MEMORY_"),
    CEnum("ImageFormatFlag", "V4L2_FMT_FLAG_"),
    CEnum("Field", "V4L2_FIELD_"),
    #CEnum("FrameSizeType", "V4L2_FRMSIZE_TYPE_"),
    #CEnum("FrameIntervalType", "V4L2_FRMIVAL_TYPE_"),
    CEnum("InputStatus", "V4L2_IN_ST_"),
    CEnum("InputType", "V4L2_INPUT_TYPE_"),
    CEnum("InputCapabilities", "V4L2_IN_CAP_"),
    CEnum("ControlClass", "V4L2_CTRL_CLASS_"),
#    CEnum("ControlType", "V4L2_CTRL_TYPE_"),
    CEnum("ControlID", "V4L2_CID_"),
    CEnum("ControlFlag", "V4L2_CTRL_FLAG_"),
    CEnum("Priority", "V4L2_PRIORITY_"),
    CEnum("TimeCodeType", "V4L2_TC_TYPE_"),
    CEnum("TimeCodeFlag", "V4L2_TC_FLAG_"),
...
def main():
    ...
    text = TEMPLATE.format(enums_body=enums_body, structs_body=structs_body, iocs_body=iocs_body, date="", version="")
    print(text)
