...
# This file has been generated by linux.media.video.gencodes2
# Date:
# Version:
...
from linux.media.video.util import v4l2_fourcc, v4l2_fourcc_be
...
class InputCapabilities(enum.IntEnum):
...
class v4l2_pix_format(Struct):
    ...
    M._fields_ = [("ycbcr_enc", cuint), ("hsv_enc", cuint)]
...
class v4l2_frmivalenum(Struct):
    ...
    M._fields_ = [("discrete", v4l2_fract), ("stepwise", v4l2_frmival_stepwise)]
...
class v4l2_plane(Struct):
    ...
    M._fields_ = [("mem_offset", cuint), ("userptr", u64), ("fd", cint)]
...
class v4l2_buffer(Struct):
    ...
    M._fields_ = [("request_fd", cint), ("reserved", cuint)]
...
class v4l2_dv_timings(Struct):
    ...
    M._fields_ = [("bt", v4l2_bt_timings), ("reserved", cuint * 32)]

    _anonymous_ = ("m",)


v4l2_dv_timings._fields_ = [("type", cuint), ("m", v4l2_dv_timings.M)]
...
class v4l2_dv_timings_cap(Struct):
    ...
    M._fields_ = [("bt", v4l2_bt_timings_cap), ("raw_data", cuint * 32)]
...
class v4l2_ext_controls(Struct):
    ...
    M._fields_ = [("ctrl_class", cuint), ("which", cuint)]

    _anonymous_ = ("m",)


v4l2_ext_controls._fields_ = [
    ("m", v4l2_ext_controls.M),
    ("count", cuint),
    ("error_idx", cuint),
    ("request_fd", cint),
    ("reserved", cuint * 1),
...
class v4l2_querymenu(Struct):
    ...
    M._fields_ = [("name", cchar * 32), ("value", i64)]
...
class v4l2_decoder_cmd(Struct):
    class M(Union):
        ...
        M._fields_ = [("speed", cint), ("format", cuint)]

        class M(Struct):
            pass

        M._fields_ = [("data", cuint * 16)]

    M._fields_ = [("stop", M.M), ("start", M.M), ("raw", M.M)]
...
class v4l2_mpeg_vbi_fmt_ivtv(Struct):
    ...
    M._fields_ = [("itv0", v4l2_mpeg_vbi_itv0), ("ITV0", v4l2_mpeg_vbi_ITV0)]
...
class v4l2_pix_format_mplane(Struct):
    ...
    M._fields_ = [("ycbcr_enc", u8), ("hsv_enc", u8)]
...
v4l2_format._fields_ = [("type", cuint), ("fmt", v4l2_format.M)]
...
v4l2_streamparm._fields_ = [("type", cuint), ("parm", v4l2_streamparm.M)]
...
class v4l2_event_ctrl(Struct):
    ...
    M._fields_ = [("value", cint), ("value64", i64)]
...
class v4l2_dbg_match(Struct):
    ...
    M._fields_ = [("addr", cuint), ("name", cchar * 32)]

    _anonymous_ = ("m",)


v4l2_dbg_match._fields_ = [("type", cuint), ("m", v4l2_dbg_match.M)]
...
class v4l2_mbus_framefmt(Struct):
    ...
    M._fields_ = [("ycbcr_enc", u16), ("hsv_enc", u16)]
