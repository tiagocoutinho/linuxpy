...
# Date: 2024-03-06 11:25:24.599483
# System: Linux
...
class v4l2_buffer(Struct):
    ...
    M1._fields_ = [("offset", cuint), ("userptr", u64), ("planes", POINTER(v4l2_plane)), ("fd", cint)]
...
v4l2_dbg_register._fields_ = [("match", v4l2_dbg_match), ("size", cuint), ("reg", i64), ("val", i64)]
...
v4l2_subdev_crop._fields_ = [("which", cuint), ("pad", cuint), ("rect", v4l2_rect), ("reserved", cuint * 8)]
...
v4l2_subdev_frame_interval._fields_ = [("pad", cuint), ("interval", v4l2_fract), ("reserved", cuint * 9)]
