...
# Date: 2024-03-07 14:35:48.902033
# System: Linux
...
class VividControlID(enum.IntEnum):
    CUSTOM_BASE = ControlID.USER_BASE | 0xF000
    BUTTON = CUSTOM_BASE + 0
    BOOLEAN = CUSTOM_BASE + 1
    INTEGER = CUSTOM_BASE + 2
    INTEGER64 = CUSTOM_BASE + 3
    MENU = CUSTOM_BASE + 4
    STRING = CUSTOM_BASE + 5
    BITMASK = CUSTOM_BASE + 6
    INTMENU = CUSTOM_BASE + 7
    U32_ARRAY = CUSTOM_BASE + 8
    U16_MATRIX = CUSTOM_BASE + 9
    U8_4D_ARRAY = CUSTOM_BASE + 10
    AREA = CUSTOM_BASE + 11
    RO_INTEGER = CUSTOM_BASE + 12
    U32_DYN_ARRAY = CUSTOM_BASE + 13
    U8_PIXEL_ARRAY = CUSTOM_BASE + 14
    S32_ARRAY = CUSTOM_BASE + 15
    S64_ARRAY = CUSTOM_BASE + 16
    VIVID_BASE = 0x00F00000 | 0xF000
    VIVID_CLASS = 0x00F00000 | 1
    TEST_PATTERN = VIVID_BASE + 0
    OSD_TEXT_MODE = VIVID_BASE + 1
    HOR_MOVEMENT = VIVID_BASE + 2
    VERT_MOVEMENT = VIVID_BASE + 3
    SHOW_BORDER = VIVID_BASE + 4
    SHOW_SQUARE = VIVID_BASE + 5
    INSERT_SAV = VIVID_BASE + 6
    INSERT_EAV = VIVID_BASE + 7
    VBI_CAP_INTERLACED = VIVID_BASE + 8
    INSERT_HDMI_VIDEO_GUARD_BAND = VIVID_BASE + 9
    HFLIP = VIVID_BASE + 20
    VFLIP = VIVID_BASE + 21
    STD_ASPECT_RATIO = VIVID_BASE + 22
    DV_TIMINGS_ASPECT_RATIO = VIVID_BASE + 23
    TSTAMP_SRC = VIVID_BASE + 24
    COLORSPACE = VIVID_BASE + 25
    XFER_FUNC = VIVID_BASE + 26
    YCBCR_ENC = VIVID_BASE + 27
    QUANTIZATION = VIVID_BASE + 28
    LIMITED_RGB_RANGE = VIVID_BASE + 29
    ALPHA_MODE = VIVID_BASE + 30
    HAS_CROP_CAP = VIVID_BASE + 31
    HAS_COMPOSE_CAP = VIVID_BASE + 32
    HAS_SCALER_CAP = VIVID_BASE + 33
    HAS_CROP_OUT = VIVID_BASE + 34
    HAS_COMPOSE_OUT = VIVID_BASE + 35
    HAS_SCALER_OUT = VIVID_BASE + 36
    LOOP_VIDEO = VIVID_BASE + 37
    SEQ_WRAP = VIVID_BASE + 38
    TIME_WRAP = VIVID_BASE + 39
    MAX_EDID_BLOCKS = VIVID_BASE + 40
    PERCENTAGE_FILL = VIVID_BASE + 41
    REDUCED_FPS = VIVID_BASE + 42
    HSV_ENC = VIVID_BASE + 43
    DISPLAY_PRESENT = VIVID_BASE + 44
    STD_SIGNAL_MODE = VIVID_BASE + 60
    STANDARD = VIVID_BASE + 61
    DV_TIMINGS_SIGNAL_MODE = VIVID_BASE + 62
    DV_TIMINGS = VIVID_BASE + 63
    PERC_DROPPED = VIVID_BASE + 64
    DISCONNECT = VIVID_BASE + 65
    DQBUF_ERROR = VIVID_BASE + 66
    QUEUE_SETUP_ERROR = VIVID_BASE + 67
    BUF_PREPARE_ERROR = VIVID_BASE + 68
    START_STR_ERROR = VIVID_BASE + 69
    QUEUE_ERROR = VIVID_BASE + 70
    CLEAR_FB = VIVID_BASE + 71
    REQ_VALIDATE_ERROR = VIVID_BASE + 72
    RADIO_SEEK_MODE = VIVID_BASE + 90
    RADIO_SEEK_PROG_LIM = VIVID_BASE + 91
    RADIO_RX_RDS_RBDS = VIVID_BASE + 92
    RADIO_RX_RDS_BLOCKIO = VIVID_BASE + 93
    RADIO_TX_RDS_BLOCKIO = VIVID_BASE + 94
    SDR_CAP_FM_DEVIATION = VIVID_BASE + 110
    META_CAP_GENERATE_PTS = VIVID_BASE + 111
    META_CAP_GENERATE_SCR = VIVID_BASE + 112
