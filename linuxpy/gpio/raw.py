...
# Date: 2024-09-11 07:40:15.052095
# System: Linux
...
class GpioV2LineFlag(enum.IntFlag):
    USED = 1
    ACTIVE_LOW = 2
    INPUT = 4
    OUTPUT = 8
...
class GpioV2LineAttrId(enum.IntEnum):
    FLAGS = 1
    OUTPUT_VALUES = 2
    DEBOUNCE = 3


class GpioV2LineChangedType(enum.IntEnum):
    REQUESTED = 1
    RELEASED = 2
    CONFIG = 3


class GpioV2LineEventId(enum.IntEnum):
    RISING_EDGE = 1
    FALLING_EDGE = 2
