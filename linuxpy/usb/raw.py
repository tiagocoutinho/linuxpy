...
# Date: 2024-03-06 11:25:24.801642
# System: Linux
...
from linuxpy.ctypes import POINTER, Struct, Union, cchar, cint, cuint, cvoidp, u8, u16, u32
...
usbdevfs_streams._fields_ = [("num_streams", cuint), ("num_eps", cuint), ("eps", cchar * 0)]
...
usb_string_descriptor._fields_ = [("bLength", u8), ("bDescriptorType", u8), ("wData", u16 * 1)]
